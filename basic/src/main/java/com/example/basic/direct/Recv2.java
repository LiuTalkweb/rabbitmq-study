package com.example.basic.direct;
...
public class Recv2 {
    ...
    private final static String ROUTE_KEY = "email";
    ...
    public static void main(String[] argv) throws Exception {
        ...
        channel.queueBind(QUEUE_NAME, EXCHANGE_NAME, ROUTE_KEY);//指定接收发送方指定routing key为email的消息
